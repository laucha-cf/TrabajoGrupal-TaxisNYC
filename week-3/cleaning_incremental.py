...
df_outliers.to_csv(f'../processed_data/carga_incremental/outliers_{month_stamp}.csv')
df1.to_csv(f'../processed_data/carga_incremental/data_taxis_nyc_{month_stamp}.csv')
